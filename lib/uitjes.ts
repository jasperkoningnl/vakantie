...
export const uitjes: Uitje[] = [
  ...
  { id: 'u1', type: 'entertainment', name: "Plan d'Eau des Chênes", desc: "Recreatiemeer met zandig strandje, picknickplek en speeltuin. Ideaal voor Lena.", drive: "15 min", coords: [44.335, 1.034], wiki: "https://nl.wikipedia.org/wiki/Montaigu-de-Quercy", gmaps: "https://www.google.com/maps/search/?api=1&query=Plan+d'Eau+des+Chênes+Montaigu-de-Quercy", lena: true },
