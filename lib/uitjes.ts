...
export const uitjes: Uitje[] = [
  { id: 'u1', type: 'entertainment', name: "Plan d'Eau des Chênes", desc: "Recreatiemeer met veilig zandstrandje, ideaal voor Lena.", drive: "15 min", coords: [44.385, 1.140], site: "https://www.montaiguplage82.com", gmaps: "https://www.google.com/maps/search/?api=1&query=Plan+d'Eau+des+Chênes+Montaigu-de-Quercy" },
  { id: 'u2', type: 'entertainment', name: "Parc en Ciel", desc: "Natuurpark met klimparcours en zwemvijver.", drive: "45 min", coords: [44.628, 0.872], site: "https://parc-en-ciel.com/", gmaps: "https://www.google.com/maps/search/?api=1&query=Parc+en+Ciel+Biron" },
  ...
  { id: 'u16', type: 'culture', name: "Musée de l'Insolite", desc: "Eigenzinnig museum vol bizarre objecten in Cabrerets.", drive: "1u 10m", coords: [44.505, 1.654], site: "https://www.museedelinsolite.com/", gmaps: "https://www.google.com/maps/search/?api=1&query=Musée+de+l'Insolite+Cabrerets" },
  ...
  { id: 'u18', type: 'culture', name: "Chartres en Lumières", desc: "Avondlichtshows op historische gebouwen. Gratis, spectaculair. Start bij zonsondergang.", drive: "5 min lopen", coords: [48.4470, 1.4880], site: "https://www.chartresenlumieres.com/fr/", gmaps: "https://www.google.com/maps/search/?api=1&query=Chartres+en+Lumières" },
  { id: 'u19', type: 'entertainment', name: "Parc des Bords de l'Eure", desc: "Mooi park langs de rivier, speeltuin aanwezig. Lekker voor Lena na een dag in de auto.", drive: "10 min lopen", coords: [48.4430, 1.4850], site: "https://www.chartres.fr/parcs-jardins-squares", gmaps: "https://www.google.com/maps/search/?api=1&query=Parc+des+Bords+de+l'Eure+Chartres" },
  { id: 'u7', type: 'food', vegetarian: true, name: "L'Estaminet", desc: "Informeel eten aan een autovrij plein in Lauzerte. Vegetarische opties aanwezig.", drive: "25 min", coords: [44.256, 1.137], gmaps: "https://www.google.com/maps/search/?api=1&query=L'Estaminet+Lauzerte" },
  { id: 'u8', type: 'food', vegetarian: true, name: "Le Petit Rapporteur", desc: "Ongedwongen sfeer in Montcuq, vegetariersvriendelijk.", drive: "20 min", coords: [44.339, 1.208], gmaps: "https://www.google.com/maps/search/?api=1&query=Le+Petit+Rapporteur+Montcuq", site: "https://www.lepetitrapporteur-montcuq.com/" },
