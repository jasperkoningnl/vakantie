...
export const reiskalender: Record<string, KalenderEntry> = {
  ...
  '2025-06-14': { type: 'vakantie', verblijf: 'Safaritent', coords: [44.398, 1.119] },
  '2025-06-15': { type: 'vakantie', verblijf: 'Safaritent', coords: [44.398, 1.119] },
  '2025-06-16': { type: 'vakantie', verblijf: 'Safaritent', coords: [44.398, 1.119] },
  '2025-06-17': { type: 'vakantie', verblijf: 'Safaritent', coords: [44.398, 1.119] },
  '2025-06-18': { type: 'vakantie', verblijf: 'Safaritent', coords: [44.398, 1.119] },
  '2025-06-19': { type: 'vakantie', verblijf: 'Safaritent', coords: [44.398, 1.119] },
  '2025-06-20': { type: 'vakantie', verblijf: 'Gîte L', opmerking: 'Verhuisdag naar Gîte L', coords: [44.398, 1.119] },
  '2025-06-21': { type: 'vakantie', verblijf: 'Gîte L', coords: [44.398, 1.119] },
  '2025-06-22': { type: 'vakantie', verblijf: 'Gîte L', coords: [44.398, 1.119] },
  '2025-06-23': { type: 'vakantie', verblijf: 'Gîte L', coords: [44.398, 1.119] },
  '2025-06-24': { type: 'vakantie', verblijf: 'Gîte L', coords: [44.398, 1.119] },
  '2025-06-25': { type: 'vakantie', verblijf: 'Gîte L', coords: [44.398, 1.119] },
  '2025-06-26': { type: 'vakantie', verblijf: 'Gîte L', coords: [44.398, 1.119] },
